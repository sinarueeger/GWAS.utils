---
title: "GWAS.utils package"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{GWAS.utils package}
...
There is an additional trick, using the log argument and then backtransforming it using `exp`, to compute the P-value for Z=38, but for Z=39 this does not work anymore. 
